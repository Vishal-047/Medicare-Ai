...
const SpeechAnalysis = () => {
  ...
  const startRecording = () => {
    ...
    setTimeout(() => {
      setTranscript("I have been experiencing a persistent headache for the past three days, along with some nausea and sensitivity to light. The pain is mostly on the right side of my head and gets worse when I move around.");
